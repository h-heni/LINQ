  ...
  public class SamplesViewModel : ViewModelBase
  {
    ...
    public List<Product> TakeWhileMethod()
    {
      ...
      List<Product> list = new();
            ...
            //list = products.Select(p => p).TakeWhile(p => p.ListPrice > 30.00m).ToList();
            list = (from p in products select p).TakeWhile(p => p.Name.StartsWith("H")).ToList();
      return list;
    }
    #endregion
    ...
    public List<Product> SkipWhileMethod()
    {
      ...
      // Write Method Syntax Here
     list=products.SkipWhile(p => p.ListPrice > 35.00m).ToList();
    ...
    public List<string> DistinctWhere()
    {
      ...
      List<string> list = new();
            ...
            // Write Method Syntax Here
            list = products.Select(p => p.Color).Distinct().ToList();
    ...
    public List<Product> DistinctByQuery()
    {
      ...
      List<Product> list = new();
            ...
            list = (from p in products select p).DistinctBy(p=>p.Color).ToList();
            return list;
    }
    #endregion
    ...
    public List<Product[]> ChunkMethod()
    {
      ...
      List<Product[]> list = new();
        ...
        // Write Method Syntax Here
        LINQ: list = products.Chunk(6).ToList();
